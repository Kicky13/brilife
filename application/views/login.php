...
<div class="login-box">
  <div class="login-logo">
    <a href="../../index2.html"><b>BRI</b>Life</a>
  </div>
  <!-- /.login-logo -->
  <div class="login-box-body">
    <h4 class="login-box-msg">Sistem Penilaian Kinerja Karyawan</h4>

    <form action="<?php echo base_url('index.php/login/login'); ?>" method="post">
      <div class="form-group has-feedback">
        <input type="text" class="form-control" placeholder="Nomor Pegawai" name="nip">
