            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    ...
                    <div class="box box-primary">
                        ...
                        <!-- /.box-header -->
                        <!-- form start -->
                        <form role="form" action="<?php echo base_url('index.php/karyawan/addKaryawan') ?>"
                              method="post">
                            <div class="box-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <br>
                                    <label>Laki-Laki
                                        <input type="radio" name="kelamin" value="1" class="flat-red form-control"
                                               checked>
                                    </label>
                                    <label>Perempuan
                                        <input type="radio" name="kelamin" value="2" class="flat-red form-control">
                                    </label>
                                </div>
                                <div class="form-group">
                                    ...
                                    <select class="form-control" name="jabatan">
                                        <?php foreach ($jabatan as $item) { ?>
                                            <option value="<?php echo $item['id_jabatan']; ?>"><?php echo $item['jabatan']; ?></option>
                                        <?php } ?>
                                    </select>
                                </div>
                                <div class="form-group">
